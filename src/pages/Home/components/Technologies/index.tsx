...
import IconNextjs from "@/assets/icons/icon-nextjs.svg?react";
...
const technologiesItemsProps = [
  {
    ...
    icon: ({ className }: { className: string }) => (
      <IconJS className={className} />
    ),
  },
  {
    title: "TypeScript",
    icon: ({ className }: { className: string }) => (
      <IconTS className={className} />
    ),
  },
  {
    title: "React",
    icon: ({ className }: { className: string }) => (
      <IconReact className={className} />
    ),
  },
  {
    title: "Next.js",
    icon: ({ className }: { className: string }) => (
      <IconNextjs className={className} />
    ),
  },
  {
    title: "Redux",
    icon: ({ className }: { className: string }) => (
      <IconRedux className={className} />
    ),
  },
  {
    title: "Sass/Scss",
    icon: ({ className }: { className: string }) => (
      <IconSass className={className} />
    ),
  },
  {
    title: "Tailwindcss",
    icon: ({ className }: { className: string }) => (
      <IconTailwind className={className} />
    ),
  },
  {
    title: "Git",
    icon: ({ className }: { className: string }) => (
      <IconGit className={className} />
    ),
  },
];
  ...
  return (
    <div className="py-16 sm:py-24">
      <div className="container flex flex-col items-center">
        <Chip className="mb-4">Технологии</Chip>
